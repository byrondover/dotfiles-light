...
export ZSH=/Users/byron/.oh-my-zsh
...
# Automatically upgrade itself without prompting you.
...
#plugins=(git)
plugins=(brew git npm pip)

# User configuration

export PATH="/Users/byron/google-cloud-sdk/bin:/usr/local/opt/coreutils/libexec/gnubin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"
